pub const ARABIC_ALLOWED: [u32; 45] = [
    ...
    0x0639, 0x063A, 0x0641, 0x0642, 0x0644, 0x0645, 0x0646, 0x0647, 0x0648, 0x0649, 0x064B, 0x064D,
    0x0651, 0x0670, 0x067E, 0x0686, 0x0698, 0x06A9, 0x06AF, 0x06C0, 0x06CC,
];
